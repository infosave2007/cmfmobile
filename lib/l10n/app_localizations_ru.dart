...
class AppLocalizationsRu extends AppLocalizations {
  ...
  String memoryWarnBody(String need, String total) {
    return 'Для запуска модели нужно около $need оперативной памяти. В устройстве $total RAM, приложению доступна лишь часть — загрузка может завершиться ошибкой или работать очень медленно.';
  }
